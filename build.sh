...
usage() {
    ...
    # echo "  --with_dependencies=(default: false)                         :  Build aml datamodel along with dependencies [zmq and protobuf]"
    echo "  -c                                                           :  Clean aml datamodel Repository and its dependencies"
