...
class Event : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:datamodel.Event) */ {
 public:
  Event();
  virtual ~Event();
  ...
  const ::datamodel::Reading& reading(int index) const;
  ::datamodel::Reading* mutable_reading(int index);
  ::datamodel::Reading* add_reading();
 ...
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::datamodel::Reading > reading_;
...
class Reading : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:datamodel.Reading) */ {
 public:
  Reading();
  virtual ~Reading();
